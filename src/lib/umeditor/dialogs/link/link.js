(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ...
            ".edui-dialog-link .edui-link-txt{width:350px;height:150px;line-height:22px;border:1px solid #d7d7d7;}" +
            "</style>" +
            "<table class=\"edui-link-table\">" +
            "<tr>" +
            "<td></td>" +
        //<label for=\"href\"><%=lang_input_url%></label>
        // "<td><input class=\"edui-link-txt\" id=\"edui-link-Jhref\" type=\"textarea\" /></td>" +
           "<td><textarea class=\"edui-link-txt\" id=\"edui-link-Jhref\"  /></textarea><textarea class=\"edui-link-txt\" id=\"edui-link-Jtitle\" style=\"display:none;\" /></textarea></td>" +
            "</tr>" +
         //   "<tr>" +
