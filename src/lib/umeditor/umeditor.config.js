...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,imageFieldName:"FileName"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数


        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义 
        //  map| undo redo | strikethrough superscript subscript | selectall cleardoc paragraph | emotion 'formula' 
        //unlink   image video  fullscreen
        ,toolbar:[
